...
bool GameOverScene::init()
{
    ...
    auto label = Label::createWithSystemFont("GAME OVER", "Times New Roman", 50); // создаем метку для вывода текста. 
    ...
    label->setPosition(cocos2d::Vec2(460, 350)); // рисуем по заданным координатам. По - умолчанию у всех компонентов Cocos - 2dx точка отрисовки находится в середине, не слева сверху!
